                ...
                <div class="form-group m-b-0">
                    ...
                    <div class="col-sm-5">
                        {!! Form::select('sort',
                            ...
                            ], (isset($sort)?$sort : null),['profile-id' => $id,'data-sub' => (isset($subItem)?$subItem : null),'data-type' => (isset($main_type)?$main_type : 'text'),'class' => 'form-control sort-items']
                        )
                        !!}
                                ...
                                <div class="row templates m-b-10" id="styles_div">
                                    <div class="col-xs-12 p-l-0 p-r-0 main_div_for_styles_1">
                                        ...
                                        <div class="for_title_17 col-xs-12 col-md-12"><a
                                                    href="{!! url('admin/uploads/assets/profiles/edit/'.$id.'/style_preview',$style->id) !!}">{{ $style->name }}</a>
                                        </div>
                                        <div class="for_number_17 col-xs-12 col-md-12">ITEMS:
                                            <div class="for_number_circle_17">{{ count($style->items) }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
