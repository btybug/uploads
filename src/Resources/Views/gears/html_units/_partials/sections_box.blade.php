    ...
    <div class="layout clearfix">
        ...
        <div class="layoutData">
            <div class="layoutCol">
                ...
                <a data-href="{!! url('/admin/uploads/gears/sections/delete') !!}" data-key="{!! $current->slug !!}" data-type="Section"  class="p-a-r-10-t-0 delete-button btn btn-danger"><i class="fa fa-trash-o"></i></a>
                @endif
            </div>
            <div class="layoutFooter row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 ">
                    <span class="textWrap"><a href="{!! @$current->author_site !!}" class="link"><i>{!! @$current->author_site !!}</i></a></span>
                </div>
