        ...
        <div class="layoutData">
            <div class="layoutCol">
                ...
                @if($unit && !$unit->is_core)
                    <a data-href="{!! url('/admin/uploads/gears/units/delete') !!}" data-key="{!! $unit->slug !!}" data-type="Unit" class="p-a-r-10-t-0 delete-button btn btn-danger"><i class="fa fa-trash-o"></i></a>
                @endif
            </div>
