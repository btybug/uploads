        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
            <div class="row">
                <div class="col-xs-12 col-sm-12 unit-box">
                    @include('uploads::gears.units._partials.ps_box')
                </div>
            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 p-l-0 p-r-0">
                        <div class="template-upload-button clearfix">
                            ...
                            <ul class="editIcons list-unstyled ">
                                <li>
                                    <a data-href="#" class="delete-button btn trashBtn"><i class="fa fa-trash-o"></i></a>
                                </li>
                                <li><a href="#" class="btn copyBtn"><i class="fa fa-clone"></i></a></li>
                                <li><a href="#" class="btn editBtn"><i class="fa fa-pencil"></i></a></li>
                            </ul>

                            <a href="{!! url('/admin/uploads/gears/page-sections/settings',$currentPageSection->slug) !!}" id="viewType" class="btn btn-sm pull-right btnUploadWidgets">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("body").on('click', ".make-active-section", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{!! url('/admin/uploads/gears/page-sections/make-active') !!}",
                    cache: false,
                    datatype: "json",
                    data: {
                        slug: slug,
