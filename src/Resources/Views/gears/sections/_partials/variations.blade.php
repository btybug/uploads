            ...
            <div class="row templates m-b-10 ">
                <div class=" topRow p-l-0 p-r-0">
                    ...
                    <div class="tempalte_icon">
                        <div><a href="{!! url('/admin/uploads/gears/sections/settings', $variation->id) !!}"
                                class="m-r-10"><i class="fa fa-pencil f-s-14"></i> </a></div>
                        @if(count($variations)>1)
                            <div>
                                <a data-href="{!! url('/admin/uploads/gears/sections/delete-variation') !!}" data-key="{!! $variation->id !!}" data-type="Section Variation" class="delete-button addons-delete delete_layout">
