        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
            <div class="row">
                <div class="col-xs-12 col-sm-12 unit-box">
                    @include('uploads::gears.units._partials.sections_box')
                </div>
            </div>
                ...
                @if($current)
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 p-l-0 p-r-0">
                        <div class="template-upload-button clearfix">
                            ...
                            <a href="{!! url('/admin/uploads/gears/sections/settings',$current->slug) !!}" id="viewType" class="btn btn-sm pull-right btnUploadWidgets">
            ...
            <div class="templates-list  m-t-20 m-b-10">
                <div class="row m-b-10">
                    ...
                    <div class="raw tpl-list">
                        @if($current)
                            @include('uploads::gears.sections._partials.variations')
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url'=>'/admin/uploads/gears/sections/upload','class'=>'dropzone', 'id'=>'my-awesome-dropzone']) !!}
