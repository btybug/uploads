            ...
            <div class="row templates m-b-10 ">
                <div class=" topRow p-l-0 p-r-0">
                    ...
                    <div class="tempalte_icon">
                        <div><a href="{!! url('/admin/uploads/gears/main-body/settings',$variation->id) !!}"
                        ...
                        @if(count($variations)>1)
                            <div>
                                <a data-href="{!! url('/admin/uploads/gears/main-body/delete-variation') !!}" data-key="{!! $variation->id !!}" data-type="Main Body Variation" class="delete-button addons-delete delete_layout">
