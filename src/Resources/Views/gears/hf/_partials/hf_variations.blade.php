            ...
            <div class="row templates m-b-10 ">
                <div class=" topRow p-l-0 p-r-0">
                    ...
                    <div class="tempalte_icon">
                        <div><a href="{!! url('/admin/uploads/gears/h-f/settings',$variation->id) !!}"
                                class="m-r-10"><i class="fa fa-pencil f-s-14"></i> </a></div>
                        @if(count($variations)>1)
                            <div>
                                <a data-href="{!! url('/admin/uploads/gears/h-f/delete-variation') !!}" data-key="{!! $variation->id !!}" data-type="H&F Variation"  class="delete-button addons-delete delete_layout">
